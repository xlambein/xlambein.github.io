...
![](/assets/img/ludum-dare-44-001.png)
_The game screen.  In the center is the planet with the asteroids to deflect.  The left shows a basic UI with score, current and next objectives._
...
![](/assets/img/ludum-dare-44-002.png)
_The 100€ bill for my money dating sim concept._
...
![](/assets/img/ludum-dare-44-003.png)
_The planet and a few asteroids from "Biomass"._
...
[<img src="/assets/img/ludum-dare-44-005.png" width="500">
_Me venting my frustration on Twitter the next morning._](https://twitter.com/xlambein/status/1122419438555471872)
...
![](/assets/img/ludum-dare-44-004.gif)
_Throwing asteroids at the planet with the slingshot.  Gravity was added shortly after that._
...
> the bad [aseroid] impact had both big effect (resetting your progress and possibly knocking you down a level) and too little of an effect (basically just set you a bit back) at the same time; I think the impact should be bigger but it would be easier to get back on so it doesn’t drag jumping up and down levels
...
If you haven't yet, I invite you to check out my game from [last December](https://lambein.xyz/blog/2018/12/05/ludum-dare-43-sacrifice.html).  However, know that it's a pain to install :-D