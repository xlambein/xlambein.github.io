...
var vectors = [{ vector: [1, 1] }, { vector: [1, .5] }, { vector: [1, 0] }, { vector: [1, -.5] }, { vector: [1, -1] }, { vector: [.5, 1] }, { vector: [0, 1] }, { vector: [-.5, 1] }, { vector: [.5, -1] }, { vector: [0, -1] }, { vector: [-.5, -1] }, { vector: [-1, 1] }, { vector: [-1, .5] }, { vector: [-1, 0] }, { vector: [-1, -.5] }, { vector: [-1, -1] }];
...
for (var i = 0; i < vectors.length; i++) {
	vectors[i].color = colorGradient2D.apply(undefined, _toConsumableArray(vectors[i].vector));
}
